...
import { updateAddress, userMeta } from '../../redux/slices/apiSlice';
import { useDispatch } from 'react-redux';

const BussinessLanguageScreen = ({navigation,route}) => {
 ...
 await AsyncStorage.setItem('language', item);      setSelectedLanguage(item);
      const country = '';
      const language = item;
      const currency = '';
...
export default BussinessLanguageScreen;
